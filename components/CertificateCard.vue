...
export default {
  ...
  methods: {
    goToCertificate(print) {
      window.location = `https://http://newschool-api-dev2.eba-gxtzwa9m.us-east-2.elasticbeanstalk.com/#/pagina-certificado/${this.idUser}/${this.certificate.courseId}/${print}`;
    },
    imageLoadError() {
